...
const HeroSection = ({ image, heading,className }) => {
  ...
  return (
      ...
      <motion.div  className="flex items-center relative h-[65vh] w-full justify-center">
        ...
        <div className='absolute left-0    -bottom-1  h-20 w-20 bg-white' style={{clipPath:  'polygon(0 0, 0% 100%, 100% 100%)'}}><div className='absolute inset-0 ' style={{  background: 'linear-gradient(135deg, #ff9a9e 0%, #fad0c4 100%)',filter:'blur(100px)'}}></div></div>
        <div className='absolute right-0   -bottom-1 h-20 w-20  bg-white' style={{clipPath: 'polygon(0 100%, 100% 0, 100% 100%)'}}><div className='absolute inset-0 ' style={{  background: 'linear-gradient(135deg, #ff9a9e 0%, #fad0c4 100%)',filter:'blur(100px)'}}></div></div>
