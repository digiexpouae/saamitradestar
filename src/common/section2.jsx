...
const warehouse=({image,heading,text,description,description2,className,className2,clstext,cls1,cls3,cls4,desccls})=>{
    return(
    
    
    <div className="flex items-center  flex-col justify-center w-full">
              <div className="hidden md:flex flex-col items-center w-full my-10  justify-center gap-6 mx-auto"> 
...
<p className={`font-medium text-[20px] leading-[1.3] ${desccls}`}>{description2}</p>
         ...
         <div className="flex md:hidden flex-col items-center w-full my-10  justify-center gap-6 mx-auto"> 
