...
<h2 className={`text-[35px] md:text-[40px] w-full leading-[1]  text-black font-semibold ${clsheading} `}>Custom Clearance</h2>
        <p className={`text-black font-medium py-4 text-[20px]   leading-[1.5] md:leading-[1.3] ${clstext} `}style={{lineClamp:6}}>The major activities of the Organization covers various disciplines of material handling. We have well-trained and approved customs clearing staff that enables precision and efficient clearance of goods at majour gateways through customs enabling consignee to receive goods in shortest possible duration.</p>
        <p className={`text-black font-medium py-4 text-[20px]   leading-[1.5] md:leading-[1.3] ${clstext} `}style={{lineClamp:6}}>Completion of all post shipment formalities and endorsements enabling clients to complete their commercial transactions without any hindrances.</p>
        </div>
...
<p className={`text-black font-medium py-4 text-[20px]   leading-[1.5] md:leading-[1.3] ${clstext} !text-start`}style={{lineClamp:6}}>The major activities of the Organization covers various disciplines of material handling. We have well-trained and approved customs clearing staff that enables precision and efficient clearance of goods at majour gateways through customs enabling consignee to receive goods in shortest possible duration.</p>
<p className={`text-black font-medium py-4 text-[20px]   leading-[1.5] md:leading-[1.3] ${clstext} !text-start`}style={{lineClamp:6}}>Completion of all post shipment formalities and endorsements enabling clients to complete their commercial transactions without any hindrances.</p>
        </div>
