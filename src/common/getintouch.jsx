...
const getintouch = () => {
    return (<>
        ...
        <div className="hidden md:flex w-full items-center justify-center h-96 relative px-4"
            style={{
                background: 'linear-gradient(185.17deg , #FFF0F1 -21.25%, #FFFFFF 98.8%)'
            }}>
            <div className="flex items-center gap-4 justify-between w-84 max-w-5xl h-full mx-auto w-full ">
                ...
                <div className=" relative  flex justify-end  h-full w-1/2"><Image src={'/assets/services/m-1.png'} width={700} height={420} loading="lazy" className="object-contain -bottom-10" /></div>
