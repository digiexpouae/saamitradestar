...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 backdrop-blur-[10px] bg-[#FFFFFF99] opacity-60 -z-[1]"></div>
        ...
        {/* Desktop Nav */}
        <div className="hidden lg:flex w-1/2 h-[70%] gap-6 pt-4 items-center justify-center text-black">
          <Link className="font-semibold text-sm duration-1000 ease-out" href={"/"}>
            Home
          </Link>
          <Link className="font-semibold text-sm duration-1000 ease-out" href={"/about"}>
            About
          </Link>
          ...
          <div className="relative">
            <Link
              href="/services"
              className="font-semibold text-sm hover:text-blue-600 transition-colors duration-300 peer"
            >
              Services
            </Link>
          ...
          <Link className="font-semibold text-sm duration-1000 ease-out" href={"/career"}>
            Career
          </Link>
          <Link className="font-semibold text-sm duration-1000 ease-out" style={{ whiteSpace: "nowrap" }} href={"/contact"}>
            Contact Us
          </Link>
        </div>
