      ...
      <div className=" mx-auto  flex-col flex  md:flex-row md:h-[70%] py-10 items-start justify-center  md:flex-row  gap-10 md:gap-20">
        ...
        <div className="md:w-1/2">
          ...
          <div className="mt-4 flex md:flex-row flex-col text-sm w-full " style={{ flexWrap: 'wrap' }}>
            ...
            <div className="flex  items-center gap-2 p-2 md:justify-center"><div className="w-6 h-4 flex items-center justify-center relative"><Image src={'/assets/footer/email.svg'} width={20} height={20} className="object-cover" /> </div><p className="text-white text-md md:text-sm "> Das@tradestarindia.com
            </p></div>
