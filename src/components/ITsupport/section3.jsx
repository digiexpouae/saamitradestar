...
const Section3 = () => {
  ...
  <>
  {/* mobile */}
    <div className="w-full py-16 md:hidden flex">
  ...
  {/* desktop */}
  <div className="w-full py-16 hidden md:flex ">
      <div className="w-[90%] md:w-[80%] mx-auto flex flex-col items-center   justify-center ">
        <div className="text-center mb-4">
          <h2 className="text-3xl md:text-4xl  font-semibold text-gray-900 mb-4">
          Few Key Functionalities of our Wms are          </h2>
        ...
        <div 
           ...
           src={'/assets/warehouse/w-icon.svg'} 
              ...
              <p className="text-sm md:text-[20px] w-[85%]  leading-[1.3] font-medium text-gray-600">customized reports of inbound and outbound</p>
            </div>
      </div>
    </div>
  </>
