...
export default function SaamiSection() {
  return (
    <section className=" py-16 px-6 md:px-12 lg:px-24 text-center text-gray-800" style={{backgroundColor:'rgba(255, 245, 245, 1)'}}>
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-5xl  font-semibold tracking-tighter mb-4" style={{color:'rgba(237, 48, 57, 1)'}}>
         ...
         <span className="" style={{color:'rgb(26, 19, 19)'}}> Saami  <br /> Tradestar Logistics Limited Has Pioneered <br />
          Supply Chain Management Solutions</span>
        </h2>
        <h1 className="text-3xl md:text-5xl font-semibold mb-4">
       
        </h1>
        <p className=" mb-12 max-w-3xl text-xl mx-auto leading-[1.2]" style={{color:'rgba(90, 90, 90, 1)'}}>
          as a 3PL in Domestic and International Logistics. STL has carved a
          niche as a 3PL within the Service Parts Logistics (SPL) and Expedited
          Time Definite Air Service.
        </p>
...
<div className="w-14 h-14 mb-4"><Image src={'/assets/section1/Group 27.svg'} width={100} height={100} className="object-cover" /></div>
            ...
            <div className="absolute right-0 bottom-0  h-20 w-20" style={{clipPath: 'polygon(100% 49%, 100% 73%, 100% 100%, 75% 100%, 0 100%, 31% 50%);',backgroundColor:'rgba(255, 245, 245, 1)'}}></div>
