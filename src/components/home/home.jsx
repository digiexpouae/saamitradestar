  ...
  return (
    <div className=" flex items-center relative h-[100vh] w-full justify-center  " ref={containerRef}>
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url('/assets/section1/h-1.webp')", borderBottomLeftRadius: '65px', borderBottomRightRadius: '65px', backgroundSize: 'cover', backgroundPosition: 'center', clipPath: 'circle(0% at 50% 50%)', // start hidden as circle
