...
<div className=" w-[80%] mx-auto h-full flex md:flex-row flex-col items-center justify-center gap-10 md:gap-20 md:justify-between">
<div className="w-full h-1/3 md:h-[60%]  md:w-1/2 relative">
...
<div className="md:w-1/2">
  ...
  <p className="text-base  md:text-xl leading-tight">
