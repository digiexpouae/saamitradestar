...
<div className={`flex items-center justify-center  p-10 md:p-0  ${className}`} ref={ref} style={{willChange:'transform'}}>
    <div className="flex lg:flex-row flex-col md:items-center  justify-center md:justify-between  gap-8">
...
{btn && <div className=" mt-4 inline-block rounded-full w-32 p-[1px] bg-gradient-to-b from-[#ED3039] to-[#FF7D83]">
 <button className= "cursor-pointer hover:bg-red-100 w-full px-4 py-2 rounded-full bg-white text-[#ED3039]"   style={{ pointerEvents: "auto" }}>
  <Link href="/warehousing" className="cursor-pointer">  Learn More</Link>
  </button>
</div>}
