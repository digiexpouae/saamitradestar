...
<div className="flex flex-col w-full md:w-1/2  lg:w-[30%]"><p className="text-center text-lg mb-2" style={{whiteSpace:'nowrap'}}>Certification Quality Management System</p><div className="h-[400px] w-full relative"><Image src={'/assets/about/c2.webp'} className="object-fit rounded-2xl" sizes="(max-width:768px)80vw,(max-width:1200px)40vw,30vw"  fill /></div></div>
...
<div className="flex w-full  justify-center gap-4 lg:gap-10" style={{flexWrap:'wrap'}}>
<div className="h-[200px] flex items-center justify-center w-full md:w-[45%] relative md:mb-8"><Image src={'/assets/about/c4.webp'}  className=" rounded-xl w-full h-auto" height={250} width={300} /></div>
<div className="h-[200px] flex items-center justify-center w-full md:w-[45%] relative md:mb-8 "><Image src={'/assets/about/c5.webp'}  className=" rounded-xl w-full h-auto" height={250} width={300} /></div>
