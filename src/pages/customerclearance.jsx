...
const customer=()=>{
    ...
    return(
        <div>
            ...
            <Fadein> <Section2  heading="Custom Clearance" text="" className="md:h-[35vh] " cls4={'  hidden'} cls3={'md:w-full'} description={description} clstext={'hidden'} description2={description2}  /></Fadein>
