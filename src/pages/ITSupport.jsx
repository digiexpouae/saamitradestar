...
const ITSupport=()=>{
   ...
   const text="By automating key processes, from inbound goods arrival to inventory storage and fulfillment of outbound orders, Warehouse Management System (WMS) gives us closer control of procurement, manufacturing and distribution activities.For the better service to our clients we do modification in our WMS timely."
   const text2=<>Registered customers of Saami can make advanced queries on the status of their shipments, and can keep track of them. Customers have option of downloading the entire waybill tracking data - schedule the download, These customers can also generate and download various reports customized to meet their individual needs <br /> <span className=" font-semibold"> Very soon we are launching some more new and exciting facilities to our e-commerce customers which will help them in analyzing their business growth</span></>
   return(
        <div> 
