...
const ITSupport=()=>{
    ...
    return(
        <div> 
            ...
            <Section2 />
            <Section4 />
            <Section3  heading="E-commerce Initiatives" headingcls={'!text-[30px]'} className2={'!hidden'} className="md:h-[35vh] " cls4={'  hidden'} cls3={'md:w-full'} description={description} clstext={'hidden'} description2={description2} desccls={'font-semibold'}  />
