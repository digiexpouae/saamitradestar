...
const ITSupport=()=>{
   ...
   const text="We use the top warehouse management system technology. Our warehouse management streamlines storage, tracking, and distribution more easily. At Saami Tradestar, every client gets a personalized logistics report. This report shows the current state of their inventory and clarifies the supply chain."
