...
const career = () => {
    ...
    return (<div>
        ...
        <Fadein> <Section2 cls4={'hidden'} cls3={'md:!w-[100%]'} desccls2={"!block md:!block"} heading={heading} text={text} clsheading={'text-center'} headingcls={'!text-[30px] '} clstext={'text-center'} className2={'!hidden'} /></Fadein>
