...
const about = () => {
  ...
  return( <div>
            ...
            <Section2 image={'/assets/about/a-2.webp'} heading={heading} text={text} description={description}  description2={description2} />
            <Section3 />
            <Section4 />
            <Section5 image={'/assets/about/a-3.webp'} heading={heading2} text={text2} description={description1} description2={description3} />
            <Section6  />
